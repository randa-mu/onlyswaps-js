...
ROUTER_ADDRESS=$(jq -r '.transactions | .[] | select(.contractName=="Router") | .contractAddress' $SCRIPT_DIR/../onlyswaps-solidity/broadcast/DeployAllContracts.s.sol/$1/run-latest.json)
