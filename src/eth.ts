import { Abi, decodeErrorResult, PublicClient, TransactionReceipt } from "viem"

// throwOnError will do some magical parsing and simulation to get a useful error message
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function throwOnError(receipt: TransactionReceipt, abi: Abi, client: PublicClient, params: any) {
